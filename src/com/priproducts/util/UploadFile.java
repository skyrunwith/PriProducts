...
public class UploadFile {
     ...
     public static String upGoodsImg(MultipartFile file, HttpServletRequest request) {
    	 
    	 String path = request.getSession().getServletContext().getRealPath(Sys.Upimg.path+Sys.Upimg.goods);  
    	 String fileName = UUID.randomUUID().toString().replace("-", "").substring(1, 11)+".jpg";  
    	 ...
    	 return   Sys.Upimg.path+Sys.Upimg.goods+fileName  ;
     }
